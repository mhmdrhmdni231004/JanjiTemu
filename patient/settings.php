...
<body>
    ...
    <td class="menu-btn">
        <a href="index.php" class="non-style-link-menu menu-link">
            <img src="../img/icons/home-iceblue.svg" class="menu-icon" alt="Home">
...
<tr class="menu-row">
    <td class="menu-btn">
        <a href="doctors.php" class="non-style-link-menu menu-link">
            <img src="../img/icons/doctors-hover.svg" class="menu-icon" alt="All Doctors">
...
<tr class="menu-row">
    <td class="menu-btn">
        <a href="schedule.php" class="non-style-link-menu menu-link">
            <img src="../img/icons/session-iceblue.svg" class="menu-icon" alt="Scheduled Sessions">
            <span class="menu-text">Scheduled</span>
        </a>
    </td>
</tr>
<tr class="menu-row">
    <td class="menu-btn">
        <a href="appointment.php" class="non-style-link-menu menu-link">
            <img src="../img/icons/book-hover.svg" class="menu-icon" alt="My Bookings">
