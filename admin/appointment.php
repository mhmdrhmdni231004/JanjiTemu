...
<tr class="menu-row">
    <td class="menu-btn">
        <a href="doctors.php" class="non-style-link-menu menu-link">
            <img src="../img/icons/doctors-hover.svg" class="menu-icon" alt="Doctors">
...
<tr class="menu-row">
    <td class="menu-btn">
        <a href="schedule.php" class="non-style-link-menu menu-link">
            <img src="../img/icons/session-iceblue.svg" class="menu-icon" alt="Schedule">
...
<tr class="menu-row">
    <td class="menu-btn menu-active">
        <a href="appointment.php" class="non-style-link-menu menu-link">
            <img src="../img/icons/book-hover.svg" class="menu-icon" alt="Appointment">
