                ...
                <tr>
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <a href="settings.php?action=edit&id=<?php echo $userid ?>&error=0" class="non-style-link">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <a href="settings.php?action=view&id=<?php echo $userid ?>" class="non-style-link">
                                    <div class="dashboard-items setting-tabs" style="padding:20px;margin:auto;width:95%;display: flex;">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <a href="settings.php?action=drop&id=<?php echo $userid.'&name='.$username ?>" class="non-style-link">
                                    <div class="dashboard-items setting-tabs" style="padding:20px;margin:auto;width:95%;display: flex;">
